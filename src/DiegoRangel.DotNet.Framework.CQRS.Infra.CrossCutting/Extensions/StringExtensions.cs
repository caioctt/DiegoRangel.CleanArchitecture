...
namespace DiegoRangel.DotNet.Framework.CQRS.Infra.CrossCutting.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        /// <summary>
        /// Returns the string text Encoded to Utf-8
        /// </summary>
        /// <param name="str"></param>
        /// <exception cref="ArgumentNullException">Thrown if <paramref name="str"/> is null</exception>
        public static string ToUtf8(this string str)
        {
            return str.IsNullOrEmpty() ? null : Encoding.UTF8.GetString(Encoding.Default.GetBytes(str));
        }

        /// <summary>
        /// Returns the string text Encoded to Unicode
        /// </summary>
        /// <param name="str"></param>
        /// <exception cref="ArgumentNullException">Thrown if <paramref name="str"/> is null</exception>
